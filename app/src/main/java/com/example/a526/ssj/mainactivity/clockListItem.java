...
/**
 * Created by 仲夏丶我们一起 on 2019/5/30.
 */

public class clockListItem extends HorizontalScrollView{
    ...
    public clockListItem(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public clockListItem(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public static final String TAG=clockListItem.class.getSimpleName();
