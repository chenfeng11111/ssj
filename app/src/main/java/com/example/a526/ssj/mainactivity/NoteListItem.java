...
public class NoteListItem extends HorizontalScrollView{
    ...
    public NoteListItem(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public static final String TAG=NoteListItem.class.getSimpleName();
