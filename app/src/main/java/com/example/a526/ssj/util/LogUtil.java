...
public class LogUtil {
    ...
    private String updatePasswordUrl = "/user/updatepassword";
    private String findUserUrl = "/user/findbyid";
    ...
    public boolean updataPassword(Integer userid, String oldpassword, String newpassword, Bundle bundle) {
        try {
            URL url = new URL(hostAndPort + updatePasswordUrl);
            System.out.println(url.toString());
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public boolean register(String name, String password, String email, Bundle bundle) {
        try {
            URL url = new URL(hostAndPort + registerUrl);
            System.out.println(url.toString());
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public User findUserById(Integer userid, Bundle bundle) {
        try {
            URL url = new URL(hostAndPort + findUserUrl);
            System.out.println(url.toString());
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
